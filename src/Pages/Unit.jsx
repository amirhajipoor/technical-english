					...
					<div className="mt-6 flex gap-x-2">
						<div>
							<button
								...
								className="bg-red-600 text-sm text-white tracking-wider hover:bg-red-700 rounded-md px-4 py-2 shadow-sm flex gap-x-1 items-center"
							>
								<svg
						...
						<div>
							<Link to={`/unit/${params.unit}/edit`}>
								<button
									type="button"
									className="bg-amber-600 text-sm text-white tracking-wider hover:bg-amber-700 rounded-md px-4 py-2 shadow-sm flex gap-x-1 items-center"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 24 24"
